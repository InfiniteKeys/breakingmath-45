                ...
                <form onSubmit={handleSignUp} className="space-y-4 max-h-96 overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      value={whyJoinClub}
                      onChange={(e) => setWhyJoinClub(e.target.value)}
                      required
                    />
                  </div>
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="thursdays"
                          value="yes"
                          checked={availableThursdays === 'yes'}
                          onChange={(e) => setAvailableThursdays(e.target.value)}
                          required
                        />
                        Yes
                      </label>
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="competitions"
                          value="yes"
                          checked={interestedCompetitions === 'yes'}
                          onChange={(e) => setInterestedCompetitions(e.target.value)}
                          required
                        />
                        Yes
                      </label>
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="competitions"
                          value="no"
                          checked={interestedCompetitions === 'no'}
                          onChange={(e) => setInterestedCompetitions(e.target.value)}
                          required
                        />
                        No
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      id="signup-accessibility"
                      className="w-full p-2 border border-input rounded-md bg-background min-h-[60px]"
                      placeholder="Optional - let us know if you have any needs..."
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="interschool"
                          value="yes"
                          checked={interestedInterschool === 'yes'}
                          onChange={(e) => setInterestedInterschool(e.target.value)}
                          required
                        />
                        Yes
                      </label>
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="interschool"
                          value="no"
                          checked={interestedInterschool === 'no'}
                          onChange={(e) => setInterestedInterschool(e.target.value)}
                          required
                        />
                        No
                      ...
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          name="interschool"
                          value="not sure"
                          checked={interestedInterschool === 'not sure'}
                          onChange={(e) => setInterestedInterschool(e.target.value)}
                          required
                        />
                        Not sure
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      id="signup-prizes"
                      className="w-full p-2 border border-input rounded-md bg-background min-h-[60px]"
                      placeholder="Gift cards, books, math tools, etc..."
                      value={preferredPrizes}
                      onChange={(e) => setPreferredPrizes(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="signup-mathgrade"
                      className="w-full p-2 border border-input rounded-md bg-background"
                      value={recentMathGrade}
                      onChange={(e) => setRecentMathGrade(e.target.value)}
                      required
                    >
